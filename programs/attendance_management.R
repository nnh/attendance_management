...
# test_input_dir が定義されている場合はネットワークドライブの代わりに使用する
input_dir <- if (exists("test_input_dir", envir = .GlobalEnv)) test_input_dir else file.path(input_root, yyyymm)
